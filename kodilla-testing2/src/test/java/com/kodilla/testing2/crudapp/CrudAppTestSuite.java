...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://michalrys90.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("your username");
        ...
        try {
            driverTrello.findElement(By.id("password")).sendKeys("your password");
    ...
    @Test
    public void shouldCreateTrelloCard1() throws InterruptedException {
